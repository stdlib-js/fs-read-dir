...
```javascript
import readDir from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-dir@v0.1.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { sync } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-dir@v0.1.0-esm/index.mjs';
```
